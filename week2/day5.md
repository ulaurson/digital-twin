...
**NOTE** Do not put a URL here - it should just be the Github username, not with "[https://github.com/](https://github.com/)" at the front, or you will get cryptic errors!
...
1. Expand the **"Deployment Summary"** step at the bottom of the workflow
2. You'll see your deployment URLs:
...
3. Click on the CloudFront URL to open your Digital Twin in a browser
